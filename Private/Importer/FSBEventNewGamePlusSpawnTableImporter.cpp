...
#define LOCTEXT_NAMESPACE "FSBEventNewGamePlusSpawnTableImporter"

FString FSBEventNewGamePlusSpawnTableImporter::GetDataTableName() const
{
    return "EventNewGamePlusSpawnTable";
}

TFunction<void()> FSBEventNewGamePlusSpawnTableImporter::GetMenuCallback()
{
    return [this]()
    {
        this->Execute();
...
UScriptStruct* FSBEventNewGamePlusSpawnTableImporter::GetRowStruct() const
{
    return FSBNGPlusZoneEventSpawnTableProperty::StaticStruct();
}

void FSBEventNewGamePlusSpawnTableImporter::PopulateDataTable(UDataTable* TargetTable, const TSharedPtr<FJsonObject>& DataTableObject)
{
    // Get "Rows" Object
    ...
    for (const auto& RowPair : RowsObject->Values) {
        ...
        FSBNGPlusZoneEventSpawnTableProperty NewRow;
